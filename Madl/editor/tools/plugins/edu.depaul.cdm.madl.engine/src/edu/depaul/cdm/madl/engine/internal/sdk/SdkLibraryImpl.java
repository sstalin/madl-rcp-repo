...
public class SdkLibraryImpl implements SdkLibrary {
  /**
   * The short name of the library. This is the name used after {@code madl:} in a URI.
   */
   ...
   * intended to work on the madl2js platform.
   */
  public static final int MADL2JS_PLATFORM = 1;
  ...
  //ss
/*  @Override
  public boolean isMadl2JsLibrary() {
    return (platforms & MADL2JS_PLATFORM) != 0;
  }*/
  ...
  /**
   * Record that this library can be compiled to JavaScript by madl2js.
   */
  public void setMadl2JsLibrary() {
    platforms |= MADL2JS_PLATFORM;
  }
