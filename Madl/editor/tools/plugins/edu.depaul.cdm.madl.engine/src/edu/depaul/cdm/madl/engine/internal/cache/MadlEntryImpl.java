...
//import edu.depaul.cdm.madl.engine.utilities.ast.ASTCloner;
import edu.depaul.cdm.madl.engine.utilities.collection.BooleanArray;
import edu.depaul.cdm.madl.engine.utilities.source.LineInfo;

import java.util.ArrayList;

/**
 * Instances of the class {@code MadlEntryImpl} implement a {@link MadlEntry}.
 *
 * @coverage dart.engine
 */
public class MadlEntryImpl extends SourceEntryImpl implements MadlEntry {
  /**
   ...
   * cached. The list will be empty if the Madl file is a part rather than a library.
   */
  ...
  public MadlEntryImpl getWritableCopy() {
    MadlEntryImpl copy = new MadlEntryImpl();
    copy.copyFrom(this);
    return copy;
  }
  ...
  protected void copyFrom(SourceEntryImpl entry) {
    ...
    MadlEntryImpl other = (MadlEntryImpl) entry;
