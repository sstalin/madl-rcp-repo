...
public class SourceFactory {
  ...
  /**
   * Return the {@link MadlSdk} associated with this {@link SourceFactory}, or {@code null} if there
   * is no such SDK.
   *
   * @return the {@link MadlSdk} associated with this {@link SourceFactory}, or {@code null} if
   *         there is no such SDK
   */
  public MadlSdk getMadlSdk() {
    for (UriResolver resolver : resolvers) {
      //ss
   /*   if (resolver instanceof MadlUriResolver) {
        MadlUriResolver madlUriResolver = (MadlUriResolver) resolver;
        return madlUriResolver.getMadlSdk();
      }*/
    }
    return null;
  }
   ...
   * {@link FileBasedSource#getContents(edu.depaul.cdm.madl.engine.source.Source.ContentReceiver)}.
   *
