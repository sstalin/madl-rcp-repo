...
//ss
    /*
     * cleanAllAction = new CleanLibrariesAction(window); register(cleanAllAction);
     */
...
//ss
    //TODO
    /*
     * showInFinderAction = ShowInFinderAction.getInstance(window); register(showInFinderAction);
     */
    ...
    //TODO
    /*
     * aboutAction = new AboutMadlAction(window); register(aboutAction);
     */
...
//ss
        /*
         * if (newFileAction != null) { newFileAction.updateEnablement(); }
         */
...
//ss
    /*
     * viewDesc = WorkbenchPlugin.getDefault().getViewRegistry().find(DebuggerView.ID); menu.add(new
     * AccessibleShowViewAction(window, viewDesc, false));
     */
