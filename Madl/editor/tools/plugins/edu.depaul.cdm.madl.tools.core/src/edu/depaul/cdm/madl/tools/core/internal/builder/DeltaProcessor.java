 ...
 * As Madl related resources are encountered, registered {@link DeltaListener}s are notified.
 *
...
public class DeltaProcessor {
   ...
   * notified of Madl related resource changes.
   *
    ...
    delta.accept(new IResourceDeltaVisitor() {
      ...
      public boolean visit(IResourceDelta delta) throws CoreException {
        ...
        if (resource.getType() == IResource.FILE) {
          ...
          // Notify context of Madl source that have been added, changed, or removed
    ...
    for (IResourceDelta childDelta : delta.getAffectedChildren()) {
      ...
      childDelta.accept(new IResourceDeltaVisitor() {
        ...
        public boolean visit(IResourceDelta delta) throws CoreException {
          ...
          // Notify context of any Madl source files that have been added, changed, or removed
          if (resource.getType() == IResource.FILE) {
            if (isMadlLikeFileName(name)) {
  ...
  protected boolean visitPackagesProxy(IResourceProxy proxy, String name, File canonicalPackageDir,
    ...
    // Notify context of any Madl source files that have been added
  ...
  private void logNoLocation(IResource resource) {
    MadlCore.logInformation("No location for " + resource);
  }
