...
/**
 * Instances of the class <code>MadlBuilder</code> implement the incremental builder for Madl
 * projects and contained pub packages.
 *
 * @coverage madl.tools.core.builder
 */
public class MadlBuilder extends IncrementalProjectBuilder {
  ...
  public MadlBuilder(BuildParticipant participant) {
  ...
  private void safeRun(ParticipantRunner runner, SubMonitor subMonitor) {
    ...
    try {
      ...
      MadlCore.logError("Error notifying build participant", e);
