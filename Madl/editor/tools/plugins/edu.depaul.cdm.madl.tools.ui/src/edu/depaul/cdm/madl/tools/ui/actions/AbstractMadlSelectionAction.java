 ...
 */
public abstract class AbstractMadlSelectionAction extends InstrumentedSelectionDispatchAction {
  /**
  ...
  public AbstractMadlSelectionAction(DartEditor editor) {
    super(editor.getEditorSite());
    this.editor = editor;
    init();
  }

  public AbstractMadlSelectionAction(IWorkbenchSite site) {
    super(site);
    this.editor = null;
    init();
  }
