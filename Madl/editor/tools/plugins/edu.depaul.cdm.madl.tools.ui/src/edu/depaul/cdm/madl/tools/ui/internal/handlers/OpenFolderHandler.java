...
import edu.depaul.cdm.madl.tools.ui.actions.OpenExternalFolderDialogAction;
...
public class OpenFolderHandler extends AbstractHandler {
  ...
  public static final String COMMAND_ID = MadlUI.class.getPackage().getName() + ".folder.open"; //$NON-NLS-1$
