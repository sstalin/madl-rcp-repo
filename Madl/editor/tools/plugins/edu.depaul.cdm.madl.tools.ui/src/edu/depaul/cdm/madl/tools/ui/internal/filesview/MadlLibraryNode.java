 ...
 */
class MadlLibraryNode implements IMadlNode {
  private MadlSdkNode parent;
  private IFileStore root;
  private String name;
  private String category;

  public MadlLibraryNode(MadlSdkNode parent, IFileStore root, String name) {
    this.parent = parent;
    this.root = root;
    this.name = name;
  }

  public MadlLibraryNode(MadlSdkNode parent, IFileStore root, String name, String category) {
    this.parent = parent;
    this.root = root;
    this.name = name;
  ...
  public ImageDescriptor getImageDescriptor() {
    return MadlToolsPlugin.findImageDescriptor("icons/full/obj16/package_obj.gif");
  }
