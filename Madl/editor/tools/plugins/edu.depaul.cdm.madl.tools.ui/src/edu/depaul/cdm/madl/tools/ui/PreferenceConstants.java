...
/*
 * import com.google.dart.tools.ui.internal.text.IJavaThemeConstants; import
 * com.google.dart.tools.ui.internal.text.editor.SemanticHighlightings; import
 * com.google.dart.tools.ui.text.IMadlColorConstants; import
 * com.google.dart.tools.ui.text.editor.tmp.JavaScriptCore;
 */
...
public class PreferenceConstants {
   ...
   * </p>
   */
  public static final String EDITOR_REMOVE_TRAILING_WS = MadlCore.PLUGIN_ID
...
//  }
   ...
   */
  /*
   * @SuppressWarnings("deprecation") public static String getPreference(String key, DartProject
   * project) { String val; if (project != null) { val = new
   * ProjectScope(project.getProject()).getNode(DartUI.ID_PLUGIN).get(key, null); if (val != null) {
   * return val; } } val = new InstanceScope().getNode(DartUI.ID_PLUGIN).get(key, null); if (val !=
   * null) { return val; } return new DefaultScope().getNode(DartUI.ID_PLUGIN).get(key, null); }
   *//**
  ...
  public static void initializeDefaultValues(IPreferenceStore store) {
    ...
    // compatibility code
    /*
     * if (store.getBoolean(PreferenceConstants.CODEGEN_USE_GETTERSETTER_PREFIX)) { String prefix =
     * store.getString(PreferenceConstants.CODEGEN_GETTERSETTER_PREFIX); if (prefix.length() > 0) {
     ...
     */
    /*
     * if (store.getBoolean(PreferenceConstants.CODEGEN_USE_GETTERSETTER_SUFFIX)) { String suffix =
     * store.getString(PreferenceConstants.CODEGEN_GETTERSETTER_SUFFIX); if (suffix.length() > 0) {
     * DartCore.getPlugin().getPluginPreferences().setValue(
