...
class AnnotationTypesExtManager {
  ...
  private static class ImageData {
    ...
    Image getImage() {
      return MadlToolsPlugin.getImage("/" + pluginId + "/" + iconPath);
    }
  }
  ...
  public Image getImageForMarker(IMarker marker) {
    ...
    switch (severity) {
      case IMarker.SEVERITY_ERROR:
        return MadlToolsPlugin.getImage("icons/full/misc/error_tsk.gif");
      case IMarker.SEVERITY_WARNING:
        return MadlToolsPlugin.getImage("icons/full/misc/warn_tsk.gif");
      case IMarker.SEVERITY_INFO:
        if (priority == IMarker.PRIORITY_NORMAL) {
          return MadlToolsPlugin.getImage("icons/full/eview16/tasks_tsk.gif");
        } else {
          return MadlToolsPlugin.getImage("icons/full/misc/info.png");
        }
    }

    return MadlToolsPlugin.getImage("icons/full/misc/info_tsk.gif");
  }
