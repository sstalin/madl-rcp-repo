...
public class FilesViewLightweightDecorator implements ILightweightLabelDecorator,
  ...
  private static ImageDescriptor DESC_READ_ONLY = MadlToolsPlugin.getImageDescriptor("icons/full/ovr16/lock_ovr.png");
...
//          MadlElement madlElement = MadlCore.create(file);
//
//          if (madlElement != null) {
//            if (file.equals(madlElement.getMadlProject().getCorrespondingResource())) {
//              decoration.addOverlay(DESC_READ_ONLY, IDecoration.BOTTOM_RIGHT);
//            }
//          }
//        }
