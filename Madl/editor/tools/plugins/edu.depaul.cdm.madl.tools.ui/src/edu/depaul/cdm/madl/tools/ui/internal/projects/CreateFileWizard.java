 ...
 * <ol>
 * <li>in {@link #performFinish()} to update the Madl model and write to the .children file and</li>
...
public class CreateFileWizard extends BasicNewResourceWizard {
   ...
   */
  public static final String WIZARD_ID = "edu.depaul.cdm.madl.tools.ui.new.file"; //$NON-NLS-1$
