 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.ui.internal.dialogs;
...
public final class DialogMessages extends NLS {
  ...
  private static final String BUNDLE_NAME = "edu.depaul.cdm.madl.tools.ui.internal.dialogs.DialogMessages";//$NON-NLS-1$
