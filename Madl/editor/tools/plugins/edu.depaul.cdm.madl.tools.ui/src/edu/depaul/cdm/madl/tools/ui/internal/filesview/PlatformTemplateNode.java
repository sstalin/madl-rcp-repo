...
public class PlatformTemplateNode implements IMadlNode{
  private MadlSdkNode parent;
  private IFileStore root;
  private String name;
  private String category;

  public PlatformTemplateNode(MadlSdkNode parent, IFileStore root, String name) {
    this.parent = parent;
    this.root = root;
    this.name = name;
  }

  public PlatformTemplateNode(MadlSdkNode parent, IFileStore root, String name, String category) {
    this.parent = parent;
    this.root = root;
    this.name = name;
