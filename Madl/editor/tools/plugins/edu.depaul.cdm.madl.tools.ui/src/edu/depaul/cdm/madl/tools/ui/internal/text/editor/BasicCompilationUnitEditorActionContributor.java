...
import edu.depaul.cdm.madl.tools.ui.actions.MadlActionConstants;
...
public class BasicCompilationUnitEditorActionContributor extends BasicMadlEditorActionContributor {
 ...
 // protected SpecificContentAssistAction[] fSpecificAssistActions;
  ...
  public BasicCompilationUnitEditorActionContributor() {
    ...
    fRetargetContentAssist = new RetargetAction(
        MadlActionConstants.CONTENT_ASSIST,
        MadlEditorMessages.ContentAssistProposal_label);
    fRetargetContentAssist.setActionDefinitionId(ITextEditorActionDefinitionIds.CONTENT_ASSIST_PROPOSALS);
    fRetargetContentAssist.setImageDescriptor(MadlPluginImages.DESC_ELCL_CODE_ASSIST);
    fRetargetContentAssist.setDisabledImageDescriptor(MadlPluginImages.DESC_DLCL_CODE_ASSIST);
    ...
    fContentAssist.setImageDescriptor(MadlPluginImages.DESC_ELCL_CODE_ASSIST);
    fContentAssist.setDisabledImageDescriptor(MadlPluginImages.DESC_DLCL_CODE_ASSIST);
    ...
    //    MadlEditorMessages.getBundleForConstructedKeys(), "Editor.ChangeEncodingAction."); //$NON-NLS-1$
  }
  ...
  public void contributeToMenu(IMenuManager menu) {
    ...
    if (editMenu != null) {
      ...
      //    MadlEditorMessages.BasicEditorActionContributor_specific_content_assist_menu,
  ...
  /*
   * @see edu.depaul.cdm.madl.tools.ui.editor.BasicJavaEditorActionContributor#dispose()
   */
  @Override
  public void dispose() {
  ...
  public void init(IActionBars bars, IWorkbenchPage page) {
    ...
    bars.setGlobalActionHandler(MadlActionConstants.CONTENT_ASSIST, fContentAssist);
  }
  ...
  /*  if (fSpecificAssistActions != null) {
    ...
    actionBars.setGlobalActionHandler(
        MadlActionConstants.SHIFT_RIGHT,
        getAction(textEditor, "ShiftRight")); //$NON-NLS-1$
    actionBars.setGlobalActionHandler(
        MadlActionConstants.SHIFT_LEFT,
