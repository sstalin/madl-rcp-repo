...
public class CompilationUnitEditorActionContributor extends
  ...
  private static final boolean _showOffset = Boolean.valueOf(
      (Platform.getDebugOption("edu.depaul.cdm.madl.tools.ui/statusbar/offset"))).booleanValue() || Platform.inDebugMode() || Platform.inDevelopmentMode(); //$NON-NLS-1$
  ...
  public CompilationUnitEditorActionContributor() {
    ...
    fToggleCommentAction.setActionDefinitionId(MadlEditorActionDefinitionIds.TOGGLE_COMMENT);

    if (_showOffset) {
      fOffsetStatusField = new StatusLineContributionItem(
          IMadlEditorActionConstants.STATUS_CATEGORY_OFFSET,
          true,
          10);
    }
  }
  ...
  public void setActiveEditor(IEditorPart part) {
    ...
    if (_showOffset && textEditorExtension != null) {
      textEditorExtension.setStatusField(null, IMadlEditorActionConstants.STATUS_CATEGORY_OFFSET);
    }
