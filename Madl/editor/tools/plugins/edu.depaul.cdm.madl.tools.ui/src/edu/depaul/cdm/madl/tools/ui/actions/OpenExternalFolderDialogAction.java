...
//import edu.depaul.cdm.madl.tools.core.internal.builder.ScanCallbackProvider;
...
import edu.depaul.cdm.madl.tools.ui.internal.dialogs.DialogMessages;
...
public class OpenExternalFolderDialogAction extends InstrumentedAction implements IWorkbenchAction {
  ...
  private static final String ACTION_ID = "edu.depaul.cdm.madl.tools.ui.folder.open"; //$NON-NLS-1$

  private final IWorkbenchWindow window;

  public static final String DIALOGSTORE_LAST_DIR = MadlUI.class.getPackage().getName()
      + ".last.dir"; //$NON-NLS-1$
  ...
  public void doRun(Event event, UIInstrumentationBuilder instrumentation) {
    IDialogSettings dialogSettings = MadlToolsPlugin.getDefault().getDialogSettings();
