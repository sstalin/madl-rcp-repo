...
import edu.depaul.cdm.madl.tools.ui.internal.projects.CreateFolderWizard;
...
public class OpenNewFolderWizardAction extends AbstractOpenWizardAction implements
  ...
  private static final String ACTION_ID = "edu.depaul.cdm.madl.tools.ui.folder.new";
  ...
  public OpenNewFolderWizardAction(IWorkbenchWindow window) {
    ...
    setImageDescriptor(MadlPluginImages.DESC_TOOL_NEWPACKAGE);
