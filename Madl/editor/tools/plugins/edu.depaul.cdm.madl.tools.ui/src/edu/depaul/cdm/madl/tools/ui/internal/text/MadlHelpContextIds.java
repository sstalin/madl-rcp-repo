 ...
 * </p>
 */
public interface MadlHelpContextIds {
  public static final String PREFIX = MadlUI.ID_PLUGIN + '.';
  ...
  public static final String CONFIG_CONTAINER_ACTION = PREFIX
      + "edu.depaul.cdm.madl.tools.ui.config_container_action"; //$NON-NLS-1$
  ...
  public static final String MADL_EDITOR_PREFERENCE_PAGE = PREFIX
  ...
  public static final String CALL_HIERARCHY_TOGGLE_JAVA_LABEL_FORMAT_ACTION = PREFIX
      + "call_hierarchy_toggle_madl_label_format_action_context"; //$NON-NLS-1$
