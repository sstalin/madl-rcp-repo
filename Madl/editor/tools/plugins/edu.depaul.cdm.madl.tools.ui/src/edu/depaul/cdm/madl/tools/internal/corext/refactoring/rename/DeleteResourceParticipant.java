 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.internal.corext.refactoring.rename;

//import edu.depaul.cdm.madl.tools.internal.corext.refactoring.util.TextChangeManager_OLD;
import edu.depaul.cdm.madl.tools.ui.internal.refactoring.RefactoringMessages;
...
/**
 * {@link DeleteParticipant} for removing resource references in Madl libraries.
 *
...
//    MadlUnit unitNode = MadlCompilerUtilities.resolveUnit(unit);
//    for (MadlDirective directive : unitNode.getDirectives()) {
