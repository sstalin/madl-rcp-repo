 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.ui.internal.refactoring;

import org.eclipse.osgi.util.NLS;

/**
 * @coverage madl.editor.ui.refactoring.ui
 */
public final class RefactoringMessages extends NLS {
  ...
  // RenameMadlElementAction
  public static String RenameMadlElementAction_name;
  public static String RenameMadlElementAction_exception;
  public static String RenameMadlElementAction_not_available;
  // RefactorActionGroup
  public static String RefactorActionGroup_no_refactoring_available;
  // MadlStatusContextViewer
  public static String MadlStatusContextViewer_no_source_available;
  ...
  // XXX
  // These constants are not used yet in Madl refactoring.
  //
