...
import edu.depaul.cdm.madl.tools.core.generator.NewFileGenerator;
...
public class CreateFileWizardPage extends WizardNewFileCreationPage {
  ...
  public IFile createNewFile() {
    ...
    if (fileName.indexOf(".") == -1) { //$NON-NLS-1$
      setFileName(fileName + ".madl"); //$NON-NLS-1$
    }
  ...
  protected boolean validatePage() {
    ...
    if ((!hasExtension || hasExtension && MadlCore.isMadlLikeFileName(fileName))
